...
// ── AudioSprite ─────────────────────────────────────────────────────────────
// Hidden <audio> kept in sync with the Stage playhead. Maps timeline time
// 1:1 into the source starting at `start`. Pauses with the Stage; seeks
// with scrubbing. Browsers may block autoplay-with-sound until a gesture —
...
Object.assign(window, {
  ...
  TextSprite, ImageSprite, RectSprite, VideoSprite, AudioSprite,
  Stage, PlaybackBar,
});
...
function SceneStage(props) {
  ...
  var soundtrack = props.soundtrack;
  var inner = (
    <React.Fragment>
