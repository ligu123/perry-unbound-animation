    ...
    return (
      <Pal.Provider value={pal}>
        <div style={{ position: 'fixed', inset: 0, background: pal.paper }}>
          <SceneStage width={1600} height={900} bg={pal.paper} scenes={window.OM_SCENES} playback={window.OM_PLAYBACK} soundtrack="./assets/a-little-higher.mp3?v=2" soundtrackVolume={1} persistKey="perry-intro-v3">
